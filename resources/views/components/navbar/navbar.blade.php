<div class="fixed bottom-0 left-0 w-full bg-white border-t border-gray-300">
    <div class="flex justify-around items-center py-3 ">
      <a href="/admin/dashboard" class="flex flex-col items-center p-2 rounded-lg hover:bg-primary hover:text-white">
      ...
      <a href="/admin/income" class="flex flex-col items-center p-2 rounded-lg hover:bg-primary hover:text-white">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
      ...
      <a href="/admin/accounts" class="flex flex-col items-center py-2 px-4 rounded-lg hover:bg-primary hover:text-white">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
